...
>
> This file should now be treated as a historical partial-review note only. The operative full-pass Round 2 record is `adv/archive/edits & guides/n11/aw-adv_n11_qa_review_round2.md`.
...
- `python scripts/module_tool.py validate --path adv/archive/md/revised_modules_n9/aw-adv_mod1_n9.md`
- `python scripts/module_tool.py validate --path adv/archive/md/revised_modules_n9/aw-adv_mod6_n9.md`
...
- Unit 11: `adv/md/final/modules/aw-adv_mod3_n10.md` contains `#### Data Interpretation Input (B7)`
- Unit 13: `adv/md/final/modules/aw-adv_mod4_n10.md` contains `#### Data Interpretation Input (B7)`
- Unit 17: `adv/md/final/modules/aw-adv_mod5_n10.md` contains `#### Data Interpretation Input (B7)`
- Unit 21: `adv/md/final/modules/aw-adv_mod6_n10.md` contains `#### Data Interpretation Input (B7)`
...
- Unit 15: `adv/md/final/modules/aw-adv_mod4_n10.md` contains `#### Reading-to-Write Input (B6)`
- Unit 18: `adv/md/final/modules/aw-adv_mod5_n10.md` contains `#### Reading-to-Write Input (B6)`
- Unit 19: `adv/md/final/modules/aw-adv_mod6_n10.md` contains `#### Reading-to-Write Input (B6)`
- Unit 22: `adv/md/final/modules/aw-adv_mod6_n10.md` contains `#### Reading-to-Write Input (B6)`
...
- Unit 4 in `adv/md/final/modules/aw-adv_mod2_n10.md`: `H3`, then `H1`
- Unit 5 in `adv/md/final/modules/aw-adv_mod2_n10.md`: `H3`, then `H1`
- Unit 6 in `adv/md/final/modules/aw-adv_mod2_n10.md`: `H2`, then `H3`, then `H1`
- Unit 7 in `adv/md/final/modules/aw-adv_mod2_n10.md`: `H3`, then `H1`
...
- Manual inspection shows:
  - Unit 14 `E4` in `adv/md/final/modules/aw-adv_mod4_n10.md` clearly separates:
    - `Task 1 — Internal notice (80–100 words)`
    - `Task 2 — External notice (160–200 words)`
  - Unit 22 `E4` in `adv/md/final/modules/aw-adv_mod6_n10.md` clearly separates:
...
- Unit 23 in `adv/md/final/modules/aw-adv_mod6_n10.md` contains `#### Self-Editing Checklist — Rubric-Based (F3)` with a ten-criterion table and a three-point scale
...
- Unit 15 `H3` in `adv/md/final/modules/aw-adv_mod4_n10.md`
