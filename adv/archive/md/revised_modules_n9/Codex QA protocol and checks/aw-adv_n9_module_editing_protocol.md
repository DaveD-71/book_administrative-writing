...
5. Strong benchmark wording already present in `adv/archive/md/revised_modules_n9/aw-adv_mod1_n9.md`
...
Use `adv/archive/md/revised_modules_n9/aw-adv_mod1_n9.md` as a quality benchmark for student-facing prompts.
