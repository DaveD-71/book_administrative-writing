...
*Document version: Updated after completion of N9 Task B across Modules 1–6. The active revised module set is `adv/md/revised_modules_n9/aw-adv_mod1_n9.md` to `aw-adv_mod6_n9.md`; Step 17 heading/code corrections are incorporated. The existing QA artifacts in `adv/md/revised_modules_n9/Codex QA protocol and checks` are N9 controls, not the final N11 book-wide QA framework.*
