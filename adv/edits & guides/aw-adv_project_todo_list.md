...
|---|---|---|---|---|
| P1 | Reduce formulaic unit structure repetition | Variety built in by design via structural profiles (N5/N8). Verify during N9 that structural variety is reflected in the edited module files. | N8, N9 | 🔄 In progress — checked during module-by-module N9 work; final book-wide confirmation still pending under N11 |
...
1. **N10 — Task C: language instruction strengthening** (book-wide pedagogical pass, now that N9 is complete)
2. **Remaining P tasks** — P1 (final structural variety confirmation during N10/N11), and P7 (Unit 23 rubric) after Unit 23 is finalised and before book sign-off
3. **N11 — QA checklist** (book-wide standards check, after N10 and relevant P tasks)
4. **Full review** (final pass, after N11)
...
| Prompt-writing policy | `aw-adv_prompt-writing-policy.md` is a source-of-truth document for drafting and revision work, especially for D, E, and H tasks; prompt design must follow learning-goal alignment, professional verisimilitude, PAST-R, calibration, scenario-list parallelism, JPO option rules, and H-section ordering |
...
*Document version: Updated after completion of N9 Task B across Modules 1–6. The active revised module set is `adv/md/revised_modules_n9/aw-adv_mod1_n9.md` to `aw-adv_mod6_n9.md`; Step 17 heading/code corrections are incorporated, and module-level N9 QA artifacts are stored in `adv/md/revised_modules_n9/Codex QA protocol and checks`.*
