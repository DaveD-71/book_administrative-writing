...
def define_character_styles(doc: Document):
    specs = [
        ...
        ("Div Label Process Char", FONTS["heading"], 10, COLORS["muted_blue"], False, False),
        ("Div Label Language Char", FONTS["heading"], 10, COLORS["blue_grey"], False, False),
        ("Div Label Principle Char", FONTS["heading"], 10, COLORS["muted_blue"], False, False),
        ...
        ("Div Label Base Char", FONTS["heading"], 10, COLORS["grey"], False, False),
        ("Div Label Self-Study Char", FONTS["heading"], 10, COLORS["grey"], False, False),
