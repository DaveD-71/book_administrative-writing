...
def define_character_styles(doc: Document):
    specs = [
        ...
        ("Div Label Process", FONTS["heading"], 10, COLORS["muted_blue"], False, False),
        ("Div Label Language", FONTS["heading"], 10, COLORS["blue_grey"], False, False),
        ("Div Label Principle", FONTS["heading"], 10, COLORS["muted_blue"], False, False),
        ("Div Label Transfer", FONTS["heading"], 10, COLORS["muted_orange"], False, False),
        ("Div Label Teaching", FONTS["heading"], 10, COLORS["muted_blue"], False, False),
        ("Div Label Note", FONTS["heading"], 10, COLORS["grey"], False, False),
        ("Div Label Bad", FONTS["heading_medium"], 10, COLORS["muted_red"], False, False),
        ("Div Label Good", FONTS["heading_medium"], 10, COLORS["muted_green"], False, False),
        ("Div Label Worked Example", FONTS["heading"], 10, COLORS["blue_grey"], False, False),
        ("Div Label Example", FONTS["heading"], 10, COLORS["grey"], False, False),
        ("Div Label Placeholder", FONTS["mono"], 8, COLORS["grey"], False, False),
        ("Div Label Self-Stuy", FONTS["heading"], 10, COLORS["grey"], False, False),
