...
|---|---|---|---|---|---|
| `model-bad` | ⚠️ | `U+26A0, U+FE0F` | Original Text | 23 | Standardized to the single label `Original Text`. |
| `model-good` | ✅ | `U+2705` | Revised Text<br>Overview<br>Key Points Discussed<br>Decisions / Action Items<br>Next Steps<br>Overall Assessment<br>Strengths<br>Areas For Improvement<br>Recommendation<br>Identify Improvements In<br>Key Points<br>Implications<br>Summary<br>Issues Identified<br>Actions Taken | 23<br>2<br>1<br>1<br>2<br>1<br>1<br>1<br>2<br>3<br>1<br>1<br>1<br>1<br>1 | Primary model title is standardized to `Revised Text`; subordinate section labels remain in use inside some `model-good` blocks. |
