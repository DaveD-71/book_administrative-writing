...
**Requirement source:** `adv/edits & guides/n10/aw-adv_n10_language_instruction_framework.md` Section 9 — these six items are the agreed minimum deliverables for a unit to be treated as N10-complete. Presence of explanation layer labels (`Why this works`, `Teaching point`, etc.) is necessary but not sufficient evidence of compliance; all six items must be confirmed.
