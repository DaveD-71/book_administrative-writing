...
> The arrow (→) in each pattern label shows the order in which ideas are presented in the sentence.

1. **Pattern 1: Main Idea → Reason**
...
2. **Pattern 2: Purpose Clause → Main Action**
...
3. **Pattern 3: Segmenting Dense Content**
