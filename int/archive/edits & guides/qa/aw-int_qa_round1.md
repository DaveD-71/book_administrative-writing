...
- Result: `Pass`
- Evidence:
  - the current project-control files still identify the six module files in `int/md/final/modules` as the live source
...
- Evidence:
  ...
  - the earlier Unit 23 pinned support items are no longer only deferred:
    - `P1` is now implemented in `int/md/final/modules/aw-int_mod6.md`
    - `P2` is now implemented in `int/md/final/supplemental/aw-int_unit23_portfolio_marking_note.md`
- Required action:
...
- Result:
  - `Pass`
- Evidence:
  - Unit 23 now includes a learner-facing `Portfolio Review Rubric` in `int/md/final/modules/aw-int_mod6.md`
  - the companion teacher / QA support now exists at `int/md/final/supplemental/aw-int_unit23_portfolio_marking_note.md`
