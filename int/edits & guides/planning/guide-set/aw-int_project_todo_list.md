...
> Items are grouped by priority and timing. **Now** items are agreed and ready to action. **Pinned** items are confirmed for later. Update status as work progresses.
...
## REFERENCE — Current Project Defaults
