...
| Structural profiles | `int/edits & guides/planning/guide-set/aw-int_unit_structural_profiles_revised.md` |
...
1. complete Module 2 profiles in `aw-int_unit_structural_profiles_revised.md`
2. continue through Modules 3 to 6 using the live module files as the source
