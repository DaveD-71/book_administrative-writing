...
- The latest active QA round record remains the governing pre-full-review baseline and is not being silently bypassed.
- Any earlier full-review findings that were already resolved or explicitly accepted are identified before the new round begins.
...
- The review will assess the six live module files as one book, not as isolated local passes.
- The reviewer has identified which issues are out of scope for full review:
  - derived combined-file regeneration
  - final print-layout execution
...
- no unresolved full-review finding remains severe enough to block post-review support-material work
