...
For now, `int/archive/md/units/aw-int-01.md` to `int/archive/md/units/aw-int-23.md` and `int/md/final/aw-int-all.md` should be treated as reference material rather than the live source of truth. The combined draft can be regenerated later after the module files have been revised and signed off.
