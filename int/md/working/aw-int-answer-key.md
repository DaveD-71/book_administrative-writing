## Administrative Writing — Intermediate: Answer Key
...
- 1b: Brings subject to front; removes embedded clause
- 2b: Uses a direct polite imperative; removes the formal passive opening
...
|---|---------|------|---------------------|
| 1 | Our office | received | your email _(yesterday = adverb)_ |
| 2 | The applicant | submitted | the additional documents |
| 3 | We | will check | the application _(today = adverb)_ |
...
4. The applicant has not submitted the fee yet.
...
3. The system is under maintenance, so we cannot access your file at the moment.
...
3. Would it be possible for you to check the file?
...
3. I believe there may be an error in the information provided. Could you please check?
...
**Model rewrite:**
> Subject: Correct File Required — Application Review
>
> Dear [Name],
>
> Thank you for your message. I noticed that the file received does not appear to be the correct version for this review. Could you please send the correct file today? I appreciate your assistance.
>
> Thank you.
...
3. C: These issues form part of the initial documentation review. _(broader context)_
...
3. I am writing because there is a problem with the online system → **Online System Issue**
4. I need to know why the applicant has not received the confirmation → **Confirmation Notice Status**
...
3. I would like to provide an update regarding the scheduled system maintenance.
...
> Subject: Question About Submitted File
>
> Dear [Name],
>
> I am writing to ask about the file received this morning. I have a question about one section: could you clarify what is required on page 3? There also appears to be some missing information in the document. Please let me know if I have misunderstood.
>
> Thank you.
> [Name]
...
1. "The document is not correct." — _Which document? What exactly is incorrect?_
...
3. Could you provide more details about which specific documents are required for this stage?
...
3. I am not sure what information is required in this section. Could you clarify what I should include here?
...
2. Could you confirm whether we should submit directly to your office or through the shared system?

**Scenario 2:** Two files named "Application_Final"
1. Could you confirm which version of the file is correct for this month's review?
2. Could you clarify the submission dates of the two versions so we can identify the most recent one?

**Scenario 3:** "Please prepare the report." (no details given)
1. Could you let me know which data should be included in the report?
...
3. Could you explain what I should do with this form? I am not sure which section requires my input.
...
1. "The review will be delayed." — _By how long? Why?_
2. "The schedule has changed." — _What changed? What is the new schedule?_
3. "We cannot finish this today." — _What task? When will it be complete?_
...
3. The report will be submitted on Monday instead of Friday because additional information is needed for one section.
...
1. B: The system will be under maintenance on Friday. _(what is happening)_
2. C: Users may not be able to access certain functions. _(effect on users)_
...
3. The submission procedure has been updated to include an additional identification check. This change applies to all new applications from this month. Further details will be shared in the updated guidelines.
...
**Situation: Review delayed for additional verification.**

**Model email:**

> Subject: Review Delay — Additional Verification Required
>
> Dear [Name],
>
> I am writing to inform you that the review planned for this week has been delayed. Additional verification is required for two of the submitted documents. This may affect the original schedule by one to two days. We will confirm a new timeline once the verification is complete.
>
...
3. Could you please check Section 2 of the form and confirm whether the information is complete?
...
3. Could you confirm whether the applicant's submission date has been recorded correctly in the system?
...
3. Could you check this when you have a moment?
4. Could you send the corrected file at your earliest convenience?
...
**Situation: Request the applicant's updated contact information.**

**Model email:**

> Subject: Updated Contact Information Required
>
> Dear Mr./Ms. [Name],
>
> I am writing to request your current contact details for our records. We need this information to proceed to the next stage of your review. Could you please provide your current email address and telephone number at your earliest convenience? This will help us confirm the next steps with you directly.
>
...
3. Could you please review this and send your feedback at your earliest convenience?
...
3. Review the form to identify any missing sections.
...
1. A: Review the file for missing documents. _(first check)_
2. D: Confirm the submission date. _(verification)_
3. C: Enter the applicant's information into the system. _(data entry)_
...
2. Download the file.
3. **Review the file for completeness and accuracy.**
4. **Save the final version with the correct file name.**

**Procedure 2:**
1. Review the applicant's form.
2. Check for required signatures.
3. **Confirm that all required documents are attached.**
...
4. Save the document to the selected subfolder.
...
3. Rename the file using the standard format.
4. Save the renamed file to the correct shared folder.
...
2. **H** (Heading)
3. **E** (Essential information — note about older files)
4. **N** (Next step)
...
> **Internal Notice — Document Access Issue**
>
...
1. "The system isn't working." — _Which system? When? What is the effect?_
2. "There is a problem with the file." — _Which file? What kind of problem?_
3. "The review is delayed." — _By how long? Why? What is the new timeline?_
...
3. We are unable to complete the verification check today because the required information has not yet been submitted. We will update you once all materials are received.
...
3. The uploaded form is incomplete. / _Sections 3 and 5 do not contain the required information._ / _The applicant has been notified and will need to resubmit a corrected version._
...
**Situation: System error stopping reviewers from accessing files.**
...
3. **M** (Main point — what was discussed and found)
...
3. The form was reviewed and found to contain incomplete information in two sections. The document coordinator will prepare a corrected version before Friday.
...
**Situation: April schedule meeting; two tasks need more time; IT update needed first; next meeting Tuesday.**
...
###### Accuracy Check Before You Finish
...
###### What Makes These Sentences Unclear?
...
###### Clarity Check Before You Finish
...
###### Write Two Tone-Improved Emails
...
> Could you please send us the correct version of the form at your earliest convenience?

**Internal Team — Make it neutral and concise:**
"They said the applicant messed up the form again." →
> The external office has reported that the submitted form contains an error. The applicant will need to provide a corrected version.

**External Office — Make it complete and professional:**
"What is the problem?" →
> Could you clarify the specific issue identified with the submitted document? This will help us prepare the corrected version promptly.

**Internal Team — Make it clear and factual:**
"The form is wrong but they didn't explain well." →
> The external office identified an error in the submitted form but did not specify the exact nature of the issue. We are awaiting clarification before taking action.
...
> Subject: Follow-Up — Form B Declaration (Application Ref: [Ref No.])
>
> Dear [External Office] Team,
>
...
##### Strong response markers by document type:
...
| Problem explanation | Issue + cause + effect + current status |
| Meeting summary | Topic + decision + action item + next step |
| Notice | Heading + background + essential info + next step |

##### Tone markers:

| Appropriate | Avoid |
|-------------|-------|
| "Could you please…" | Bare imperatives ("Send it.") |
| "I am writing to…" | Vague openers ("Hi, About that thing…") |
| "We would like to inform you that…" | Emotional language |
| Neutral explanations | Blame language ("You didn't…", "Why did you…") |


_End of Intermediate Answer Key_
